import { FC, useState, Fragment, useContext, useCallback } from "react";
...
const LoginForm: FC = () => {
  ...
  const successHandler = (data: ResponseData) => {
    authCtx.logIn(data.User.FullName, data.AuthorizationToken.Token, true);
    navigate("/home");
  };
  ...
  return (
    <Fragment>
      ...
      <div className={styles["control-group"]}>
        ...
        <Input id="password" label="password" onChange={passwordHandler} icon={passwordIcon} value={password}/>
      ...
      <Heading text="or continue as Guest" onClick={loginHandler} />
    </Fragment>
  );
};
